...
```{r, fig.width = 9, fig.asp = 0.4}
heatmap_fun(d_gh_ad_23, max_fact_fun(ncol(d_gh_ad_23)), "oblimin") +
...
```{r, fig.width = 4, fig.asp = 0.67}
heatmap_fun(d_gh_ad_23, 4, "oblimin") +
...
Following our usual protocol (eigenvalue > 1, shared variance explained > 5%, dominant for $\geq$ 1 capacity after rotation) suggests retaining `r reten_fact_fun(d_gh_ad_23, "oblimin")` factors:

```{r, fig.width = 4, fig.asp = 1}
heatmap_fun(d_gh_ad_23, reten_fact_fun(d_gh_ad_23, "oblimin"), "oblimin") +
...
```{r, include = F}
d_gh_ad_23_bic <- VSS(d_gh_ad_23, n = max_fact_fun(ncol(d_gh_ad_23)), rotate = "oblimin", plot = F)
```
...
```{r, fig.width = 4, fig.asp = 1}
heatmap_fun(d_gh_ad_23, 5, "oblimin") +
...
```{r, fig.width = 4, fig.asp = 0.67}
cluster_fun(d_gh_ad_23, reten_fact_fun(d_gh_ad_23, "oblimin"), rot = "oblimin") +
...
```{r, fig.width = 3, fig.asp = 0.9}
fa(d_gh_ad_23, 4, "oblimin")$scores[] %>%
  data.frame() %>%
  rownames_to_column("subid") %>%
...
```{r, fig.width = 9, fig.asp = 0.4}
heatmap_fun(d_gh_ch_fante_23, max_fact_fun(ncol(d_gh_ch_fante_23)), "oblimin") +
  labs(title = "Factor loadings, maximal solution: GH Children",
       subtitle = "Including all 23 capacities; after oblimin rotation",
       x = "", y = "", fill = "")
```
...
```{r, fig.width = 4, fig.asp = 0.67}
heatmap_fun(d_gh_ch_fante_23, 4, "oblimin") +
  labs(title = "Factor loadings, 4-factor solution: GH Children",
       subtitle = "Including all 23 capacities; after oblimin rotation",
       x = "", y = "", fill = "")
```
...
Following our usual protocol (eigenvalue > 1, shared variance explained > 5%, dominant for $\geq$ 1 capacity after rotation) suggests retaining `r reten_fact_fun(d_gh_ch_fante_23, "oblimin")` factors:

```{r, fig.width = 4, fig.asp = 1}
heatmap_fun(d_gh_ch_fante_23, reten_fact_fun(d_gh_ch_fante_23, "oblimin"), "oblimin") +
  labs(title = "Factor loadings, after retention: GH Children",
       subtitle = "Including all 23 capacities; after oblimin rotation",
       x = "", y = "", fill = "")
```
...
```{r, include = F}
d_gh_ch_fante_23_bic <- VSS(d_gh_ch_fante_23, n = max_fact_fun(ncol(d_gh_ch_fante_23)), rotate = "oblimin", plot = F)
```
...
```{r, fig.width = 4, fig.asp = 1}
heatmap_fun(d_gh_ch_fante_23, 2, "oblimin") +
  labs(title = "Factor loadings, minimizing BIC: GH Children",
       subtitle = "Including all 23 capacities; after oblimin rotation",
       x = "", y = "", fill = "")
```
...
```{r, fig.width = 4, fig.asp = 0.67}
cluster_fun(d_gh_ch_fante_23, reten_fact_fun(d_gh_ch_fante_23, "oblimin"), rot = "oblimin") +
  labs(title = "Hierarchical clustering within reduced factor space: GH Children",
       subtitle = "Including all 23 capacities; after oblimin rotation")
```
...
```{r, fig.width = 3, fig.asp = 0.9}
fa(d_gh_ch_fante_23, 4, "oblimin")$scores[] %>%
  data.frame() %>%
  rownames_to_column("subid") %>%
  # mutate(subid = paste("ghana", subid, sep = "_")) %>%
  gather(factor, score, -subid) %>%
...
```{r, fig.width = 9, fig.asp = 0.4}
heatmap_fun(d_gh_ad_22, max_fact_fun(ncol(d_gh_ad_22)), "oblimin") +
  labs(title = "Factor loadings, maximal solution: GH Adults",
       subtitle = "Excluding 'add and subtract numbers'; after oblimin rotation",
       x = "", y = "", fill = "")
```
...
```{r, fig.width = 4, fig.asp = 0.67}
heatmap_fun(d_gh_ad_22, 4, "oblimin") +
  labs(title = "Factor loadings, 4-factor solution: GH Adults",
       subtitle = "Excluding 'add and subtract numbers'; after oblimin rotation",
       x = "", y = "", fill = "")
```
...
Following our usual protocol (eigenvalue > 1, shared variance explained > 5%, dominant for $\geq$ 1 capacity after rotation) suggests retaining `r reten_fact_fun(d_gh_ad_22, "oblimin")` factors:

```{r, fig.width = 4, fig.asp = 1}
heatmap_fun(d_gh_ad_22, reten_fact_fun(d_gh_ad_22, "oblimin"), "oblimin") +
  labs(title = "Factor loadings, after retention: GH Adults",
       subtitle = "Excluding 'add and subtract numbers'; after oblimin rotation",
       x = "", y = "", fill = "")
```
...
```{r, include = F}
d_gh_ad_22_bic <- VSS(d_gh_ad_22, n = max_fact_fun(ncol(d_gh_ad_22)), rotate = "oblimin", plot = F)
```
...
```{r, fig.width = 4, fig.asp = 1}
heatmap_fun(d_gh_ad_22, d_gh_ad_22_bic$vss.stats %>% rownames_to_column("nfact") %>% filter(BIC == min(BIC)) %>% select(nfact) %>% as.numeric(), "oblimin") +
  labs(title = "Factor loadings, after retention: GH Adults",
       subtitle = "Excluding 'add and subtract numbers'; after oblimin rotation",
       x = "", y = "", fill = "")
```
...
```{r, fig.width = 4, fig.asp = 0.67}
cluster_fun(d_gh_ad_22, reten_fact_fun(d_gh_ad_22, "oblimin"), rot = "oblimin") +
  labs(title = "Hierarchical clustering within reduced factor space: GH Adults",
       subtitle = "Excluding 'add and subtract numbers'; after oblimin rotation")
```
...
```{r, fig.width = 3, fig.asp = 0.9}
fa(d_gh_ad_22, 4, "oblimin")$scores[] %>%
  data.frame() %>%
  rownames_to_column("subid") %>%
  mutate(subid = paste("ghana", subid, sep = "_")) %>%
  gather(factor, score, -subid) %>%
...
```{r, fig.width = 9, fig.asp = 0.4}
heatmap_fun(d_gh_ch_fante_22, max_fact_fun(ncol(d_gh_ch_fante_22)), "oblimin") +
  labs(title = "Factor loadings, maximal solution: GH Children",
       subtitle = "Excluding 'add and subtract numbers'; after oblimin rotation",
       x = "", y = "", fill = "")
```
...
```{r, fig.width = 4, fig.asp = 0.67}
heatmap_fun(d_gh_ch_fante_22, 4, "oblimin") +
  labs(title = "Factor loadings, 4-factor solution: GH Children",
       subtitle = "Excluding 'add and subtract numbers'; after oblimin rotation",
       x = "", y = "", fill = "")
```
...
Following our usual protocol (eigenvalue > 1, shared variance explained > 5%, dominant for $\geq$ 1 capacity after rotation) suggests retaining `r reten_fact_fun(d_gh_ch_fante_22, "oblimin")` factors:

```{r, fig.width = 4, fig.asp = 1}
heatmap_fun(d_gh_ch_fante_22, reten_fact_fun(d_gh_ch_fante_22, "oblimin"), "oblimin") +
  labs(title = "Factor loadings, after retention: GH Children",
       subtitle = "Excluding 'add and subtract numbers'; after oblimin rotation",
       x = "", y = "", fill = "")
```
...
```{r, fig.width = 4, fig.asp = 1}
heatmap_fun(d_gh_ch_fante_22, 2, "oblimin") +
  labs(title = "Factor loadings, after retention: GH Children",
       subtitle = "Excluding 'add and subtract numbers'; after oblimin rotation",
       x = "", y = "", fill = "")
```
...
```{r, include = F}
d_gh_ch_fante_22_bic <- VSS(d_gh_ch_fante_22, n = max_fact_fun(ncol(d_gh_ch_fante_22)), rotate = "oblimin", plot = F)
```
...
```{r, fig.width = 4, fig.asp = 0.67}
cluster_fun(d_gh_ch_fante_22, reten_fact_fun(d_gh_ch_fante_22, "oblimin"), rot = "oblimin") +
  labs(title = "Hierarchical clustering within reduced factor space: GH Children",
       subtitle = "Excluding 'add and subtract numbers'; after oblimin rotation")
```
...
```{r, fig.width = 3, fig.asp = 0.9}
fa(d_gh_ch_fante_22, 4, "oblimin")$scores[] %>%
  data.frame() %>%
  rownames_to_column("subid") %>%
  # mutate(subid = paste("ghana", subid, sep = "_")) %>%
  gather(factor, score, -subid) %>%
...
Minimizing BIC suggests retaining `r d_vt_ad_22_bic$vss.stats %>% rownames_to_column("nfact") %>% filter(BIC == min(BIC)) %>% select(nfact) %>% as.numeric()` factors: 

```{r, fig.width = 4, fig.asp = 1}
heatmap_fun(d_th_ch_22, 2, "oblimin") +
  labs(title = "Factor loadings, minimizing BIC: VT Adults",
       subtitle = "Excluding 'add and subtract numbers'; after oblimin rotation",
       x = "", y = "", fill = "")
```
...
```{r, fig.width = 9, fig.asp = 0.4}
heatmap_fun(d_us_ad_pilot_21, max_fact_fun(ncol(d_us_ad_pilot_21)), "oblimin") +
  labs(title = "Factor loadings, maximal solution: US Adults (MTurk Pilot)",
       subtitle = "Excluding 'add and subtract numbers' and 'pray'; after oblimin rotation",
       x = "", y = "", fill = "")
```
...
```{r, fig.width = 4, fig.asp = 0.67}
heatmap_fun(d_us_ad_pilot_21, 4, "oblimin") +
  labs(title = "Factor loadings, 4-factor solution: US Adults (MTurk Pilot)",
       subtitle = "Excluding 'add and subtract numbers' and 'pray'; after oblimin rotation",
       x = "", y = "", fill = "")
```
...
Following our usual protocol (eigenvalue > 1, shared variance explained > 5%, dominant for $\geq$ 1 capacity after rotation) suggests retaining `r reten_fact_fun(d_us_ad_pilot_21, "oblimin")` factors:

```{r, fig.width = 4, fig.asp = 1}
heatmap_fun(d_us_ad_pilot_21, reten_fact_fun(d_us_ad_pilot_21, "oblimin"), "oblimin") +
  labs(title = "Factor loadings, after retention: US Adults (MTurk Pilot)",
       subtitle = "Excluding 'add and subtract numbers' and 'pray'; after oblimin rotation",
       x = "", y = "", fill = "")
```
...
```{r, include = F}
d_us_ad_pilot_21_bic <- VSS(d_us_ad_pilot_21, n = max_fact_fun(ncol(d_us_ad_pilot_21)), rotate = "oblimin", plot = F)
```
...
```{r, fig.width = 4, fig.asp = 0.67}
cluster_fun(d_us_ad_pilot_21, reten_fact_fun(d_us_ad_pilot_21, "oblimin"), rot = "oblimin") +
  labs(title = "Hierarchical clustering within reduced factor space: US Adults (MTurk Pilot)",
       subtitle = "Excluding 'add and subtract numbers', 'pray'; after oblimin rotation")
```

### Attributions to characters

```{r, fig.width = 3, fig.asp = 0.9}
fa(d_us_ad_pilot_21, 4, "oblimin")$scores[] %>%
  data.frame() %>%
  rownames_to_column("subid") %>%
  gather(factor, score, -subid) %>%
  full_join(read.csv("/Users/kweisman/Documents/Research (Stanford)/Projects/Templeton Grant/DEVELOPMENTAL TASKS/beetles:dimkid:factors/analysis/_US pilot/beetles_pilot2_tidy.csv") %>%
...
```{r, fig.width = 9, fig.asp = 0.4}
heatmap_fun(d_gh_ad_21, max_fact_fun(ncol(d_gh_ad_21)), "oblimin") +
  labs(title = "Factor loadings, maximal solution: GH Adults",
       subtitle = "Excluding 'add and subtract numbers' and 'pray'; after oblimin rotation",
       x = "", y = "", fill = "")
```
...
```{r, fig.width = 4, fig.asp = 0.67}
heatmap_fun(d_gh_ad_21, 4, "oblimin") +
  labs(title = "Factor loadings, 4-factor solution: GH Adults",
       subtitle = "Excluding 'add and subtract numbers' and 'pray'; after oblimin rotation",
       x = "", y = "", fill = "")
```
...
Following our usual protocol (eigenvalue > 1, shared variance explained > 5%, dominant for $\geq$ 1 capacity after rotation) suggests retaining `r reten_fact_fun(d_gh_ad_21, "oblimin")` factors:

```{r, fig.width = 4, fig.asp = 1}
heatmap_fun(d_gh_ad_21, reten_fact_fun(d_gh_ad_21, "oblimin"), "oblimin") +
  labs(title = "Factor loadings, after retention: GH Adults",
       subtitle = "Excluding 'add and subtract numbers' and 'pray'; after oblimin rotation",
       x = "", y = "", fill = "")
```
...
```{r, include = F}
d_gh_ad_21_bic <- VSS(d_gh_ad_21, n = max_fact_fun(ncol(d_gh_ad_21)), rotate = "oblimin", plot = F)
```
...
```{r, fig.width = 4, fig.asp = 1}
heatmap_fun(d_gh_ad_21, d_gh_ad_21_bic$vss.stats %>% rownames_to_column("nfact") %>% filter(BIC == min(BIC)) %>% select(nfact) %>% as.numeric(), "oblimin") +
  labs(title = "Factor loadings, after retention: GH Adults",
       subtitle = "Excluding 'add and subtract numbers' and 'pray'; after oblimin rotation",
       x = "", y = "", fill = "")
```
...
```{r, fig.width = 4, fig.asp = 0.67}
cluster_fun(d_gh_ad_21, reten_fact_fun(d_gh_ad_21, "oblimin"), rot = "oblimin") +
  labs(title = "Hierarchical clustering within reduced factor space: GH Adults",
       subtitle = "Excluding 'add and subtract numbers' and 'pray'; after oblimin rotation")
```
...
```{r, fig.width = 3, fig.asp = 0.9}
fa(d_gh_ad_21, 4, "oblimin")$scores[] %>%
  data.frame() %>%
  rownames_to_column("subid") %>%
  mutate(subid = paste("ghana", subid, sep = "_")) %>%
  gather(factor, score, -subid) %>%
...
```{r, fig.width = 9, fig.asp = 0.4}
heatmap_fun(d_gh_ch_21, max_fact_fun(ncol(d_gh_ch_21)), "oblimin") +
  labs(title = "Factor loadings, maximal solution: GH Children",
       subtitle = "Excluding 'add and subtract numbers' and 'pray'; after oblimin rotation",
       x = "", y = "", fill = "")
```
...
```{r, fig.width = 4, fig.asp = 0.67}
heatmap_fun(d_gh_ch_21, 4, "oblimin") +
  labs(title = "Factor loadings, 4-factor solution: GH Children",
       subtitle = "Excluding 'add and subtract numbers' and 'pray'; after oblimin rotation",
       x = "", y = "", fill = "")
```
...
Following our usual protocol (eigenvalue > 1, shared variance explained > 5%, dominant for $\geq$ 1 capacity after rotation) suggests retaining `r reten_fact_fun(d_gh_ch_21, "oblimin")` factors:

```{r, fig.width = 4, fig.asp = 1}
heatmap_fun(d_gh_ch_21, reten_fact_fun(d_gh_ch_21, "oblimin"), "oblimin") +
  labs(title = "Factor loadings, after retention: GH Children",
       subtitle = "Excluding 'add and subtract numbers' and 'pray'; after oblimin rotation",
       x = "", y = "", fill = "")
```
...
```{r, fig.width = 4, fig.asp = 1}
heatmap_fun(d_gh_ch_21, d_gh_ch_21_parallel$nfact, "oblimin") +
  labs(title = "Factor loadings, after retention: GH Children",
       subtitle = "Excluding 'add and subtract numbers' and 'pray'; after oblimin rotation",
       x = "", y = "", fill = "")
```
...
```{r, include = F}
d_gh_ch_21_bic <- VSS(d_gh_ch_21, n = max_fact_fun(ncol(d_gh_ch_21)), rotate = "oblimin", plot = F)
```
...
```{r, fig.width = 4, fig.asp = 0.67}
cluster_fun(d_gh_ch_21, reten_fact_fun(d_gh_ch_21, "oblimin"), rot = "oblimin") +
  labs(title = "Hierarchical clustering within reduced factor space: GH Children",
       subtitle = "Excluding 'add and subtract numbers' and 'pray'; after oblimin rotation")
```
...
```{r, fig.width = 3, fig.asp = 0.9}
fa(d_gh_ch_21, 4, "oblimin")$scores[] %>%
  data.frame() %>%
  rownames_to_column("subid") %>%
  mutate(subid = paste("ghana", subid, sep = "_")) %>%
  gather(factor, score, -subid) %>%
...
```{r, fig.width = 9, fig.asp = 0.4}
heatmap_fun(d_gh_ch_fante_21, max_fact_fun(ncol(d_gh_ch_fante_21)), "oblimin") +
  labs(title = "Factor loadings, maximal solution: GH Children",
       subtitle = "Excluding 'add and subtract numbers' and 'pray'; after oblimin rotation",
       x = "", y = "", fill = "")
```
...
```{r, fig.width = 4, fig.asp = 0.67}
heatmap_fun(d_gh_ch_fante_21, 4, "oblimin") +
  labs(title = "Factor loadings, 4-factor solution: GH Children",
       subtitle = "Excluding 'add and subtract numbers' and 'pray'; after oblimin rotation",
       x = "", y = "", fill = "")
```
...
Following our usual protocol (eigenvalue > 1, shared variance explained > 5%, dominant for $\geq$ 1 capacity after rotation) suggests retaining `r reten_fact_fun(d_gh_ch_fante_21, "oblimin")` factors:

```{r, fig.width = 4, fig.asp = 1}
heatmap_fun(d_gh_ch_fante_21, reten_fact_fun(d_gh_ch_fante_21, "oblimin"), "oblimin") +
  labs(title = "Factor loadings, after retention: GH Children",
       subtitle = "Excluding 'add and subtract numbers' and 'pray'; after oblimin rotation",
       x = "", y = "", fill = "")
```
...
```{r, include = F}
d_gh_ch_fante_21_bic <- VSS(d_gh_ch_fante_21, n = max_fact_fun(ncol(d_gh_ch_fante_21)), rotate = "oblimin", plot = F)
```
...
```{r, fig.width = 4, fig.asp = 1}
# heatmap_fun(d_gh_ch_fante_21, 2, "oblimin") +
#   labs(title = "Factor loadings, after retention: GH Children",
#        subtitle = "Excluding 'add and subtract numbers' and 'pray'; after oblimin rotation",
#        x = "", y = "", fill = "")
```
...
```{r, fig.width = 4, fig.asp = 0.67}
cluster_fun(d_gh_ch_fante_21, reten_fact_fun(d_gh_ch_fante_21, "oblimin"), rot = "oblimin") +
  labs(title = "Hierarchical clustering within reduced factor space: GH Children",
       subtitle = "Excluding 'add and subtract numbers' and 'pray'; after oblimin rotation")
```
...
```{r, fig.width = 3, fig.asp = 0.9}
fa(d_gh_ch_fante_21, 4, "oblimin")$scores[] %>%
  data.frame() %>%
  rownames_to_column("subid") %>%
  # mutate(subid = paste("ghana", subid, sep = "_")) %>%
  gather(factor, score, -subid) %>%
...
```{r, fig.width = 9, fig.asp = 0.4}
heatmap_fun(d_th_ad_21, max_fact_fun(ncol(d_th_ad_21)), "oblimin") +
  labs(title = "Factor loadings, maximal solution: TH Adults",
       subtitle = "Excluding 'add and subtract numbers' and 'pray'; after oblimin rotation",
       x = "", y = "", fill = "")
```
...
```{r, fig.width = 4, fig.asp = 0.67}
heatmap_fun(d_th_ad_21, 4, "oblimin") +
  labs(title = "Factor loadings, 4-factor solution: TH Adults",
       subtitle = "Excluding 'add and subtract numbers' and 'pray'; after oblimin rotation",
       x = "", y = "", fill = "")
```
...
Following our usual protocol (eigenvalue > 1, shared variance explained > 5%, dominant for $\geq$ 1 capacity after rotation) suggests retaining `r reten_fact_fun(d_th_ad_21, "oblimin")` factors:

```{r, fig.width = 4, fig.asp = 1}
heatmap_fun(d_th_ad_21, reten_fact_fun(d_th_ad_21, "oblimin"), "oblimin") +
  labs(title = "Factor loadings, after retention: TH Adults",
       subtitle = "Excluding 'add and subtract numbers' and 'pray'; after oblimin rotation",
       x = "", y = "", fill = "")
```
...
```{r, include = F}
d_th_ad_21_bic <- VSS(d_th_ad_21, n = max_fact_fun(ncol(d_th_ad_21)), rotate = "oblimin", plot = F)
```
...
```{r, fig.width = 4, fig.asp = 1}
heatmap_fun(d_th_ad_21, 2, "oblimin") +
  labs(title = "Factor loadings, minimizing BIC: TH Adults",
       subtitle = "Excluding 'add and subtract numbers' and 'pray'; after oblimin rotation",
       x = "", y = "", fill = "")
```
...
```{r, fig.width = 4, fig.asp = 0.67}
cluster_fun(d_th_ad_21, reten_fact_fun(d_th_ad_21, "oblimin"), rot = "oblimin") +
  labs(title = "Hierarchical clustering within reduced factor space: TH Adults",
       subtitle = "Excluding 'add and subtract numbers' and 'pray'; after oblimin rotation")
```
...
```{r, fig.width = 3, fig.asp = 0.9}
fa(d_th_ad_21, 4, "oblimin")$scores[] %>%
  data.frame() %>%
  rownames_to_column("subid") %>%
  mutate(subid = paste("thailand", subid, sep = "_")) %>%
  gather(factor, score, -subid) %>%
...
```{r, fig.width = 9, fig.asp = 0.4}
heatmap_fun(d_th_ch_21, max_fact_fun(ncol(d_th_ch_21)), "oblimin") +
  labs(title = "Factor loadings, maximal solution: TH Children",
       subtitle = "Excluding 'add and subtract numbers' and 'pray'; after oblimin rotation",
       x = "", y = "", fill = "")
```
...
```{r, fig.width = 4, fig.asp = 0.67}
heatmap_fun(d_th_ch_21, 4, "oblimin") +
  labs(title = "Factor loadings, 4-factor solution: TH Children",
       subtitle = "Excluding 'add and subtract numbers' and 'pray'; after oblimin rotation",
       x = "", y = "", fill = "")
```
...
Following our usual protocol (eigenvalue > 1, shared variance explained > 5%, dominant for $\geq$ 1 capacity after rotation) suggests retaining `r reten_fact_fun(d_th_ch_21, "oblimin")` factors:

```{r, fig.width = 4, fig.asp = 1}
heatmap_fun(d_th_ch_21, reten_fact_fun(d_th_ch_21, "oblimin"), "oblimin") +
  labs(title = "Factor loadings, after retention: TH Children",
       subtitle = "Excluding 'add and subtract numbers' and 'pray'; after oblimin rotation",
       x = "", y = "", fill = "")
```
...
```{r, fig.width = 4, fig.asp = 1}
heatmap_fun(d_th_ch_21, 3, "oblimin") +
  labs(title = "Factor loadings, minimizing BIC: TH Children",
       subtitle = "Excluding 'add and subtract numbers' and 'pray'; after oblimin rotation",
       x = "", y = "", fill = "")
```
...
```{r, include = F}
d_th_ch_21_bic <- VSS(d_th_ch_21, n = max_fact_fun(ncol(d_th_ch_21)), rotate = "oblimin", plot = F)
```
...
```{r, fig.width = 4, fig.asp = 0.67}
cluster_fun(d_th_ch_21, reten_fact_fun(d_th_ch_21, "oblimin"), rot = "oblimin") +
  labs(title = "Hierarchical clustering within reduced factor space: TH Children",
       subtitle = "Excluding 'add and subtract numbers' and 'pray'; after oblimin rotation")
```
...
```{r, fig.width = 3, fig.asp = 0.9}
fa(d_th_ch_21, 4, "oblimin")$scores[] %>%
  data.frame() %>%
  rownames_to_column("subid") %>%
  mutate(subid = paste("thailand", subid, sep = "_")) %>%
  gather(factor, score, -subid) %>%
...
```{r, fig.width = 9, fig.asp = 0.4}
heatmap_fun(d_vt_ad_21, max_fact_fun(ncol(d_vt_ad_21)), "oblimin") +
  labs(title = "Factor loadings, maximal solution: VT Adults",
       subtitle = "Excluding 'add and subtract numbers' and 'pray'; after oblimin rotation",
       x = "", y = "", fill = "")
```
...
```{r, fig.width = 4, fig.asp = 0.67}
heatmap_fun(d_vt_ad_21, 4, "oblimin") +
  labs(title = "Factor loadings, 4-factor solution: VT Adults",
       subtitle = "Excluding 'add and subtract numbers' and 'pray'; after oblimin rotation",
       x = "", y = "", fill = "")
```
...
Following our usual protocol (eigenvalue > 1, shared variance explained > 5%, dominant for $\geq$ 1 capacity after rotation) suggests retaining `r reten_fact_fun(d_vt_ad_21, "oblimin")` factors:

```{r, fig.width = 4, fig.asp = 1}
heatmap_fun(d_vt_ad_21, reten_fact_fun(d_vt_ad_21, "oblimin"), "oblimin") +
  labs(title = "Factor loadings, after retention: VT Adults",
       subtitle = "Excluding 'add and subtract numbers' and 'pray'; after oblimin rotation",
       x = "", y = "", fill = "")
```
...
Parallel analysis suggests retaining `r d_vt_ad_21_parallel$nfact` factors: 
...
```{r, include = F}
d_vt_ad_21_bic <- VSS(d_vt_ad_21, n = max_fact_fun(ncol(d_vt_ad_21)), rotate = "oblimin", plot = F)
```
...
```{r, fig.width = 4, fig.asp = 0.67}
cluster_fun(d_vt_ad_21, reten_fact_fun(d_vt_ad_21, "oblimin"), rot = "oblimin") +
  labs(title = "Hierarchical clustering within reduced factor space: VT Adults",
       subtitle = "Excluding 'add and subtract numbers' and 'pray'; after oblimin rotation")
```
...
```{r, fig.width = 3, fig.asp = 0.9}
fa(d_vt_ad_21, 4, "oblimin")$scores[] %>%
  data.frame() %>%
  rownames_to_column("subid") %>%
  mutate(subid = paste("vanuatu", subid, sep = "_")) %>%
  gather(factor, score, -subid) %>%
...
```{r, fig.width = 9, fig.asp = 0.4}
heatmap_fun(d_vt_ch_21, max_fact_fun(ncol(d_vt_ch_21)), "oblimin") +
  labs(title = "Factor loadings, maximal solution: VT Children",
       subtitle = "Excluding 'add and subtract numbers' and 'pray'; after oblimin rotation",
       x = "", y = "", fill = "")
```
...
```{r, fig.width = 4, fig.asp = 0.67}
heatmap_fun(d_vt_ch_21, 4, "oblimin") +
  labs(title = "Factor loadings, 4-factor solution: VT Children",
       subtitle = "Excluding 'add and subtract numbers' and 'pray'; after oblimin rotation",
       x = "", y = "", fill = "")
```
...
Following our usual protocol (eigenvalue > 1, shared variance explained > 5%, dominant for $\geq$ 1 capacity after rotation) suggests retaining `r reten_fact_fun(d_vt_ch_21, "oblimin")` factors:

```{r, fig.width = 4, fig.asp = 1}
heatmap_fun(d_vt_ch_21, reten_fact_fun(d_vt_ch_21, "oblimin"), "oblimin") +
  labs(title = "Factor loadings, after retention: VT Children",
       subtitle = "Excluding 'add and subtract numbers' and 'pray'; after oblimin rotation",
       x = "", y = "", fill = "")
```
...
```{r, include = F}
d_vt_ch_21_bic <- VSS(d_vt_ch_21, n = max_fact_fun(ncol(d_vt_ch_21)), rotate = "oblimin", plot = F)
```
...
```{r, fig.width = 4, fig.asp = 1}
heatmap_fun(d_vt_ch_21, 2, "oblimin") +
  labs(title = "Factor loadings, minimizing BIC: VT Children",
       subtitle = "Excluding 'add and subtract numbers' and 'pray'; after oblimin rotation",
       x = "", y = "", fill = "")
```
...
```{r, fig.width = 4, fig.asp = 0.67}
cluster_fun(d_vt_ch_21, reten_fact_fun(d_vt_ch_21, "oblimin"), rot = "oblimin") +
  labs(title = "Hierarchical clustering within reduced factor space: VT Children",
       subtitle = "Excluding 'add and subtract numbers' and 'pray'; after oblimin rotation")
```
...
```{r, fig.width = 3, fig.asp = 0.9}
fa(d_vt_ch_21, 4, "oblimin")$scores[] %>%
  data.frame() %>%
  rownames_to_column("subid") %>%
  mutate(subid = paste("vanuatu", subid, sep = "_")) %>%
  gather(factor, score, -subid) %>%
...
# do factor analysis on factor loadings
heatmap_fun(loadings_21, reten_fact_fun(loadings_21, "oblimin"), "oblimin")
# fa.parallel(loadings_21)
heatmap_fun(loadings_21, 4, "oblimin")

# do cluster analysis on factor loadings after factor analysis
fa(loadings_21, reten_fact_fun(loadings_21, "oblimin"), "oblimin")$loadings[] %>%
  data.frame() %>%
  dist() %>%
  hclust() %>%
  as.dendrogram() %>%
...
d_varexp_21 <- bind_rows(
  prop_var_fun(d_us_ad_pilot_21, 4, "oblimin") %>%
    mutate(site = "US", age = "adults"),
  prop_var_fun(d_gh_ch_21, 4, "oblimin") %>%
    mutate(site = "GH", age = "children"),
  prop_var_fun(d_th_ad_21, 4, "oblimin") %>%
    mutate(site = "TH", age = "adults"),
  prop_var_fun(d_th_ch_21, 4, "oblimin") %>%
    mutate(site = "TH", age = "children"),
  prop_var_fun(d_vt_ad_21, 4, "oblimin") %>%
    mutate(site = "VT", age = "adults"),
  prop_var_fun(d_vt_ch_21, 4, "oblimin") %>%
    mutate(site = "VT", age = "children")) %>%
  select(-stat) %>%
  mutate(factor = paste(tolower(site), substr(age, 1, 2), factor, sep = "_"),
         prop_var_round = format(round(prop_var, 2), digits = 2))
...
heatmap_fun(d_all_21, reten_fact_fun(d_all_21, "oblimin"), "oblimin") +
  labs(title = "Factor loadings, after retention: All samples",
       subtitle = "Excluding 'add and subtract numbers' and 'pray'; after oblimin rotation",
       x = "", y = "", fill = "")
...
heatmap_fun(d_all_21, 4, "oblimin") +
  labs(title = "Factor loadings, parallel analysis: All samples",
       subtitle = "Excluding 'add and subtract numbers' and 'pray'; after oblimin rotation",
       x = "", y = "", fill = "")
...
heatmap_fun(d_all_21, 3, "oblimin") +
  labs(title = "Factor loadings, minimizing BIC: All samples",
       subtitle = "Excluding 'add and subtract numbers' and 'pray'; after oblimin rotation",
       x = "", y = "", fill = "")
```
...
```{r, fig.width = 6, fig.asp = 0.7}
fa(d_all_21_subid, 4, "oblimin")$scores[] %>%
  data.frame() %>%
  rownames_to_column("subid") %>%
  gather(factor, score, -subid) %>%
  full_join(subids) %>%
